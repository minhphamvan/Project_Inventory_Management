...
public class ProductInfoDTO implements java.io.Serializable {
	...
	public ProductInfoDTO(CategoryDTO category, String code, String name, String imgUrl, int activeFlag, Date createDate,
			Date updateDate) {
	...
	public ProductInfoDTO(CategoryDTO category, String code, String name, String description, String imgUrl, int activeFlag,
